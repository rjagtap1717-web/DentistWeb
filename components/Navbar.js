      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <a href="#hero" className="flex items-center gap-3 group">
          ...
          <span className="relative flex items-center justify-center w-8 h-8">
            <span className="absolute inset-0 rounded-lg bg-gold-100/80 group-hover:bg-gold-200/80 transition-colors duration-400" />
            <span className="relative text-base text-gold-600 font-serif font-bold leading-none">A</span>
          </span>
          <span className="font-serif text-lg md:text-xl font-semibold tracking-wide text-charcoal-800">
            {siteInfo.name}
          </span>
        </a>
